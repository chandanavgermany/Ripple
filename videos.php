...
<section id="main_section" class="videos-wrapper">
            ...
            <div class="category-section-title" style="margin-bottom:15px;">
                    ...
                    #c0392b                        ">Computer Programming</h4>                    </dt>
                         	<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=66 ORDER BY categoryName LIMIT 5,8") or die();
					    
			               while($row=mysql_fetch_array($sql)){
                           echo '                 <dd>
                            <a href="videos_cat.php?cat='.$row['categoryID'].'"
