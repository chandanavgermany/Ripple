...
<section id="main_section" class="videos-wrapper">
            ...
            <div class="category-section-title" style="margin-bottom:15px;">
                    ...
                    #2c3e50                        ">Algebra</h4>                    </dt>
					
					<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=142 LIMIT 5") or die();
					    
			               while($row=mysql_fetch_array($sql)){
                           echo '                 <dd>
                            <a href="videos_m_cat.php?cat='.$row['categoryID'].'"
                    ...
                    <dt>
                    <h4 style="background-color:
                    #c0392b                        ">Calculus</h4>                    </dt>
                           					<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=143 LIMIT 5") or die();
                    ...
                    <dt>
                    <h4 style="background-color:
                    #16a085                        ">Geometry</h4>                    </dt>
                                         					<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=144") or die();
                    ...
                    <dt>
                    <h4 style="background-color:
                    #e67e22                        ">Statistics</h4>                    </dt>
                                            					<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=146") or die();
					    
			               while($row=mysql_fetch_array($sql)){
                           echo '                 <dd>
                            <a href="videos_m_cat.php?cat='.$row['categoryID'].'"
                                class="category-name">            '.$row['categoryName'].'                 <span
                                    style="font-size:11px; display:none;"> </span></a>
                      </dd>';
                    ...
                    <dt>
                    <h4 style="background-color:
                    #2980b9                        ">Trigonometry</h4>                    </dt>
                                            					<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=147") or die();
        ...
        <section id="right_side">
                            ...
                            <span
                    class="video-section-title">Most Popular Video - Calculating Pi with Real Pies</span>
                <div id="featured_video">
                    <iframe width="640" height="360"
                        src="//www.youtube.com/embed/ZNiRzZ66YN0" frameborder="0"
                        allowfullscreen></iframe>
                </div>
                <!-- Share Code -->
                <div class="addthis_sharing_toolbox" style="margin:5px; margin-left:-2px;"></div>
                <div class="video-description">How accurately can we calculate Pi using hundreds of real pies?</div>
