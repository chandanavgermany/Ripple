...
<section id="main_section" class="videos-wrapper">
            ...
            <div class="category-section-title" style="margin-bottom:15px;">
                                    Humanities Videos & Tutorials
                            </div>
                            <dl>
                    <dt>
                    <h4 style="background-color:
                    #2c3e50                        ">History</h4>                    </dt>
                            				<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=194 LIMIT 5") or die();
					    
			               while($row=mysql_fetch_array($sql)){
                           echo '                 <dd>
                            <a href="videos_h_cat.php?cat='.$row['categoryID'].'"
                    ...
                    <dt>
                    <h4 style="background-color:
                    #16a085                        ">Philosophy</h4>                    </dt>
                        				<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=195 ") or die();
        ...
        <section id="right_side">
                            ...
                            <span
                    class="video-section-title">Most Popular Video - Rethinking Civilization - Crash Course World History</span>
                <div id="featured_video">
                    <iframe width="640" height="360"
                        src="//www.youtube.com/embed/wyzi9GNZFMU" frameborder="0"
                        allowfullscreen></iframe>
                </div>
                <!-- Share Code -->
                <div class="addthis_sharing_toolbox" style="margin:5px; margin-left:-2px;"></div>
                <div class="video-description">This week, we'll be talking about the idea of civilization, some of the traditional hallmarks of so-called civilization, and why some people would choose to live outside the civilization model. It turns out, not everyone who lives outside of what we traditionally think of as a "civilized" social order is necessarily a barbarian!</div>
