...
<section id="main_section" class="videos-wrapper">
            ...
            <div class="category-section-title" style="margin-bottom:15px;">
                                    Business Videos & Tutorials
                            </div>
                            <dl>
                    <dt>
                    <h4 style="background-color:
                    #2c3e50                        ">Accounting</h4>                    </dt>
                             	<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=254") or die();
					    
			               while($row=mysql_fetch_array($sql)){
                           echo '                 <dd>
                            <a href="videos_b_cat.php?cat='.$row['categoryID'].'"
                    ...
                    <dt>
                    <h4 style="background-color:
                    #c0392b                        ">Finance</h4>                    </dt>
                              	<?php $sql=mysql_query("SELECT * FROM video_categories WHERE parentID=255 LIMIT 5") or die();
        ...
        <section id="right_side">
                         ...
                         <br>
                            ...
                            <span
                    class="video-section-title">Most Popular Video - Mark Cuban: Only Morons Start a Business on a Loan</span>
                <div id="featured_video">
                    <iframe width="640" height="360"
                        src="//www.youtube.com/embed/KYneLGRTgy8" frameborder="0"
                        allowfullscreen></iframe>
                </div>
                <!-- Share Code -->
                <div class="addthis_sharing_toolbox" style="margin:5px; margin-left:-2px;"></div>
                <div class="video-description">Entrepreneur Mark Cuban discusses the U.S. Economy and starting a business with Trish Regan at the Clinton Global Initiative in Chicago on Bloomberg Television's "Street Smart."</div>
                <span class="video-section-title"></span>
